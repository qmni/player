...
import { Player } from '../../../src/generated/prisma/client.ts';
    ...
    test.concurrent.each(levelMin)(
        ...
        async (level) => {
            ...
            body.content
                ...
                .forEach((lvl) =>
                    expect(lvl).toBeGreaterThanOrEqual(level),
                );
        },
    );
    ...
    test.concurrent.each(experienceMin)(
        ...
        async (experience) => {
            ...
            body.content
                ...
                .forEach((exp) =>
                    expect(exp).toBeGreaterThanOrEqual(experience),
                );
        },
    );
