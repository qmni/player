...
describe('GraphQL Queries', () => {
    ...
    test.concurrent.each(usernames)(
        ...
        async (username) => {
            ...
            const { data, errors } =
                (await response.json()) as PlayersSuccessType;
            ...
            players.forEach((player) => {
                expect(player['username'].toLowerCase()).toStrictEqual(
    ...
    test.concurrent.each(usernamesNichtVorhanden)(
        ...
        async (username) => {
            ...
            const { data, errors } =
                (await response.json()) as PlayersErrorsType;
