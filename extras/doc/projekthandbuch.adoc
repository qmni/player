...
.Router für Lesezugriffe an der REST-Schnittstelle
[plantuml,buch-router,svg]
----
include::buch-router.plantuml[]
----
...
.Router für Schreibzugriffe an der REST-Schnittstelle
[plantuml,buch-write-router,svg]
----
include::buch-write-router.plantuml[]
----
...
."BuchService" von der Geschäftslogik
[plantuml,BuchService,svg]
----
include::BuchService.plantuml[]
----

Pellentesque in ipsum id orci porta dapibus. Donec rutrum congue leo eget
malesuada.

."BuchWriteService" von der Geschäftslogik
